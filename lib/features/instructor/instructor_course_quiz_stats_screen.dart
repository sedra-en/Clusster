...
class _InstructorCourseQuizStatsScreenState
  ...
  Future<void> _load() async {
    ...
    final data =
        await ApiService.getCourseQuizStats(widget.courseId);
  ...
  List<dynamic> get _lectures =>
      (_stats['lectures'] as List<dynamic>?) ?? [];

  int get _totalEnrolled =>
      (_stats['total_enrolled'] ?? 0) as int;

  int get _uniqueParticipants =>
      (_stats['unique_participants'] ?? 0) as int;

  int get _lecturesWithQuiz =>
      (_stats['lectures_with_quiz'] ?? 0) as int;
