  ...
  Widget _buildWelcomeCard() {
    ...
    final sub =
        lecturesCount == 0
            ...
            : aiGen < lecturesCount
            ? 'lectures_need_ai'.tr().replaceAll(
              '{n}',
              '${lecturesCount - aiGen}',
            )
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      'active_courses'.tr().replaceAll('{n}', '$coursesCount'),
                      style: GoogleFonts.poppins(
                        fontSize: 11,
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            _statCard3D(
              value: "${_s('courses_count')}",
              label: 'stat_courses'.tr(),
              iconPath: AppIcons.book,
              color: AppColors.primary,
            ),
            const SizedBox(width: 10),
            _statCard3D(
              value: "${_s('lectures_count')}",
              label: 'stat_lectures'.tr(),
        ...
        Row(
          children: [
            ...
            const SizedBox(width: 10),
            _statCard3D(
              value: "${_s('ai_generated_count')}",
              label: 'stat_ai_content'.tr(),
        ...
        Row(
          children: [
            _statCard3D(
              value: "${_s('quiz_attempts')}",
              label: 'stat_quiz_attempts_label'.tr(),
              iconPath: AppIcons.checkMark,
              color: Colors.teal,
            ),
            const SizedBox(width: 10),
            _statCard3D(
              value: "${_s('published_courses')}",
              label: 'stat_published_courses'.tr(),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: AppIconImage(
                hasAI ? AppIcons.microchip : AppIcons.pdf,
                size: 22,
              ),
            ),
            const SizedBox(width: 12),
