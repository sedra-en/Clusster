...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final profile =
          await ApiService.getStudentProfile(widget.userId);
      final courses =
          await ApiService.getStudentEnrolledCourses(widget.userId);
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          _iconButton(
            imagePath:
                "assets/icons/icons8-profile-50.png",
...
class _HoverPressEffect extends StatefulWidget {
  ...
  @override
  State<_HoverPressEffect> createState() =>
      _HoverPressEffectState();
}

class _HoverPressEffectState
    extends State<_HoverPressEffect> {
  bool _hovered = false;
  bool _pressed = false;
